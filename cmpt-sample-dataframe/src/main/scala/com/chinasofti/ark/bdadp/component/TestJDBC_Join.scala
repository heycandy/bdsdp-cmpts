...
//
//    val transform = options.getParameter.getOrDefault("pipeline.transform",
//          """{"id": "2", "name": "Join", "conditionExpr": "id"}""")
//
//    val sink = options.getParameter.getOrDefault("pipeline.sink",
//      """{"id": "3", "name": "LoggerSink", "numRows": "5"}""")
//
...
//
//    val transformClazz = Class.forName("com.chinasofti.ark.bdadp.component.Join")
//      .asInstanceOf[Class[MultiTransComponent[util.Collection[Data], _ <: Data[_]]]]
//
